// Code generated by "enumer -type Action -trimprefix Action -transform snake -text -output action_string.go"; DO NOT EDIT.
...
const _ActionName = "create_groupedit_group_photoinvite_membersjoin_group_by_linkpin_messageremove_membersphone_callscore_in_gameedit_chat_theme"

var _ActionIndex = [...]uint8{0, 12, 28, 42, 60, 71, 85, 95, 108, 123}

const _ActionLowerName = "create_groupedit_group_photoinvite_membersjoin_group_by_linkpin_messageremove_membersphone_callscore_in_gameedit_chat_theme"
...
func _ActionNoOp() {
	...
	_ = x[ActionEditChatTheme-(8)]
}

var _ActionValues = []Action{ActionCreateGroup, ActionEditGroupPhoto, ActionInviteMembers, ActionJoinGroupByLink, ActionPinMessage, ActionRemoveMembers, ActionPhoneCall, ActionScoreInGame, ActionEditChatTheme}
...
var _ActionNameToValueMap = map[string]Action{
	...
	_ActionName[108:123]:      ActionEditChatTheme,
	_ActionLowerName[108:123]: ActionEditChatTheme,
}
